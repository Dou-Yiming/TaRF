...
class TouchBase(Dataset):
    def __init__(self,
        ...
        self.mother_path = '/nfs/turbo/coe-ahowens-nobackup/yiliu/diffuser/dataset/Experiment4_reverse/train'
        ...
        self.data = {
            ...
            "image_path_": [os.path.join(self.data_root, 'conditioning_images', self.image_paths[i]) for i in range(len(self.image_paths))],
            "touch_path_": [os.path.join(self.data_root, 'images', self.image_paths[i]) for i in range(len(self.image_paths))],
        }
...
class TouchTrain(TouchBase):
    def __init__(self, **kwargs):
        super().__init__(txt_file="data/objectfolder/train.txt", data_root="/nfs/turbo/coe-ahowens-nobackup/yiliu/diffuser/dataset/Experiment4_reverse/train/", **kwargs)


class TouchValidation(TouchBase):
    def __init__(self, flip_p=0., **kwargs):
        super().__init__(txt_file="data/objectfolder/train.txt", data_root="/nfs/turbo/coe-ahowens-nobackup/yiliu/diffuser/dataset/Experiment4_reverse/train/", flip_p=flip_p, **kwargs)
